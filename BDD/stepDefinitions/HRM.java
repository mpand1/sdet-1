...
public class HRM {
	...
	public void fillJobForm() throws Throwable{
		...
		driver.findElement(By.id("addJobVacancy_hiringManager")).sendKeys("Pri Gupta");
	...
	public void candidateForm() throws Throwable{
		Thread.sleep(6000);
		driver.findElement(By.id("addCandidate_firstName")).sendKeys("Meera");
		driver.findElement(By.id("addCandidate_lastName")).sendKeys("Shira");
		driver.findElement(By.id("addCandidate_email")).sendKeys("test10012@gmail.com");
		...
		public void uploadResume() throws Throwable{
			...
			uploadElement.sendKeys("C:\\Selenium Projects\\CucumliveProj\\src\\test\\resources\\Resume.docx");
		}
		@And("^Click Save$")
