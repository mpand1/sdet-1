...
public class Activity8_2 {
    public static void main(String[] args) {
        ...
        //Get columns
        List<WebElement> cols = (List<WebElement>) driver.findElements(By.xpath("//table[@id='sortableTable']/thead/tr/th"));
        //Get rows
        List<WebElement> rows = (List<WebElement>) driver.findElements(By.xpath("//table[@id='sortableTable']/tbody/tr"));
